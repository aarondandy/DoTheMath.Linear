...
namespace DoTheMath.Linear.Tests
{
    public class MatrixDTests
    {
        ...
        public class TryGetInverse : MatrixDTests
        {
            [Fact]
            public void zero_matrix_has_no_inverse()
            {
                var actual = new MatrixD(5, 5);
                var expected = new MatrixD(actual);
        ...
        public class Invert : MatrixDTests
        {
            [Fact]
        ...
        public class TryInvert : MatrixDTests
        {
            [Fact]
            public void failure_does_not_mutate()
            {
