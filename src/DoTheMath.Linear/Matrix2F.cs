...
namespace DoTheMath.Linear
{
        ...
        IEquatable<Matrix2F>
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public Matrix2F(IMatrix<float> source)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
        ...
        [Pure]
#endif
        public static Matrix2F operator /(Matrix2F matrix, float divisor)
        {
            if (matrix == null)
            {
                throw new ArgumentNullException();
        ...
        [Pure]
#endif
        public static Matrix2F CreateIdentity()
        {
            return new Matrix2F
            {
                E00 = 1.0f,
        ...
        [Pure]
#endif
        public static Matrix2F CreateRotation(float radians)
        {
            var result = new Matrix2F
            {
        ...
        [Pure]
#endif
        public static Matrix2F CreateScaled(Vector2F factors)
        {
            return new Matrix2F
            {
                E00 = factors.X,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public Matrix2F GetSum(Matrix2F other)
        {
            if (other == null)
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public Matrix2F GetDifference(Matrix2F other)
        {
            if (other == null)
            {
                throw new ArgumentNullException(nameof(other));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public Matrix2F GetScaled(float scalar)
        {
            return new Matrix2F
            {
                E00 = E00 * scalar,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public Matrix2F GetQuotient(float divisor)
        {
            return new Matrix2F
            {
                E00 = E00 / divisor,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
#endif
        public Matrix2F GetProduct(Matrix2F right)
        {
            if (right == null)
            {
        ...
        {
            var evaluator = new DeterminantEvaluator<Matrix2F, float>(new Matrix2F(this));
        ...
        public Matrix2F GetInverse()
        {
            ...
            var inverter = new GaussJordanInverter<Matrix2F, float>(
                new Matrix2F(this),
                Matrix2F.CreateIdentity());
        ...
        {
            return this.Equals(obj as Matrix2F);
        }
